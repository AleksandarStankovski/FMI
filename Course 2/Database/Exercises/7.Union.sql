...
-- Напишете заявка, която извежда името на студиото и
-- имената на актьорите участвали във филми произведени
...
-- Напишете заявка, която извежда имената на актьора (актьорите)
-- участвали във филми на най-голяма стойност
...
-- не участвали в нито един филм. (Използвайте съединение!)
...
-- за тези производители, за които съответния продукт не се
-- продава (няма го в таблиците PC, лаптоп или принтер).
...
-- Напишете заявка, която извежда цялата налична информация за
-- всеки кораб, включително и данните за неговия клас.
-- В резултата не трябва да се включват тези класове, които
-- нямат кораби.
...
-- За всяка страна изведете имената на корабите, които никога
-- не са участвали в битка
