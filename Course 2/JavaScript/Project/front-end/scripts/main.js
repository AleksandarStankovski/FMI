...
// //path to server
var serverURL = "http://localhost/Web-project/services/";
...
//This function delete events
function deleteEvents(){
    var events_id = $(this).attr('name');
    performRequest( "deleteEvents.php?events="+events_id, function(data){
        showErrorMessage(data[0].del);        
    });
    $('.read-events').remove();
    setTimeout(function(){
